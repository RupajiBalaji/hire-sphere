...
function Profile() {
  ...
  return (
    <div className="pb-8">
      ...
      <Block
        title="About"
        onEdit={() => navigate({ to: "/app/edit-profile" })}
      >
        {profile.bio ? (
      ...
      {/* ── Skills ── */}
      <Block title="Skills" onEdit={() => navigate({ to: "/app/edit-profile" })}>
      ...
      {/* ── Work Experience ── */}
      <Block title="Work Experience" onEdit={() => navigate({ to: "/app/edit-profile" })}>
      ...
      {/* ── Education ── */}
      <Block title="Education" onEdit={() => navigate({ to: "/app/edit-profile" })}>
      ...
      {/* ── Projects ── */}
      <Block title="Projects" onEdit={() => navigate({ to: "/app/edit-profile" })}>
      ...
      {/* ── Certifications ── */}
      <Block title="Certifications" onEdit={() => navigate({ to: "/app/edit-profile" })}>
      ...
      {/* ── Links ── */}
      <Block title="Links" onEdit={() => navigate({ to: "/app/edit-profile" })}>
        {[
      ...
      {strength < 50 && (
        <div className="mx-4 mt-4 rounded-3xl bg-gradient-soft p-5 ring-1 ring-primary/20">
          ...
          <button onClick={() => navigate({ to: "/app/edit-profile" })}
